...
#MAGMA annotate代码
#gene 周围加2kb
/home/u/桌面/Software/magma_v1.08b_static/magma --annotate window=2 --snp-loc snp.hg19.loc \
--gene-loc protein_coding_genes.gencode_v38lift37.chr1-22.loc  --out snp_to_gene.2kb
#enhancer
/home/u/桌面/Software/magma_v1.08b_static/magma --annotate --snp-loc snp.hg19.loc \
